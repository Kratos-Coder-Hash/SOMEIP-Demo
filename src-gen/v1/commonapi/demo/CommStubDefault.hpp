...
*/
#ifndef V1_COMMONAPI_DEMO_Comm_STUB_DEFAULT_HPP_
#define V1_COMMONAPI_DEMO_Comm_STUB_DEFAULT_HPP_
...
/**
 * Provides a default implementation for CommStubRemoteEvent and
 * CommStub. Method callbacks have an empty implementation,
 ...
 * behaviour.
 */
class COMMONAPI_EXPORT_CLASS_EXPLICIT CommStubDefault
    : public virtual CommStub {
public:
    COMMONAPI_EXPORT CommStubDefault()
        : remoteEventHandler_(this),
          interfaceVersion_(Comm::getInterfaceVersion()) {
    }
    ...
    COMMONAPI_EXPORT CommStubRemoteEvent* initStubAdapter(const std::shared_ptr< CommStubAdapter> &_adapter) {
        CommonAPI::Stub<CommStubAdapter, CommStubRemoteEvent>::stubAdapter_ = _adapter;
        return &remoteEventHandler_;
    }

    COMMONAPI_EXPORT virtual void sendMessage(const std::shared_ptr<CommonAPI::ClientId> _client, std::string _name, sendMessageReply_t _reply) {
        (void)_client;
        (void)_name;
    ...
    COMMONAPI_EXPORT virtual void fireMyStatusEvent(const int32_t &_myCurrentValue) {
        CommStub::fireMyStatusEvent(_myCurrentValue);
    }
...
protected:
    COMMONAPI_EXPORT virtual bool trySetXAttribute(int32_t _value) {
        ...
        bool valueChanged;
        std::shared_ptr<CommStubAdapter> stubAdapter = CommonAPI::Stub<CommStubAdapter, CommStubRemoteEvent>::stubAdapter_.lock();
        if(stubAdapter) {
    ...
    class COMMONAPI_EXPORT_CLASS_EXPLICIT RemoteEventHandler: public virtual CommStubRemoteEvent {
    public:
        COMMONAPI_EXPORT RemoteEventHandler(CommStubDefault *_defaultStub)
            : 
    ...
    private:
        CommStubDefault *defaultStub_;
    };
protected:
    CommStubDefault::RemoteEventHandler remoteEventHandler_;
...
#endif // V1_COMMONAPI_DEMO_Comm_STUB_DEFAULT
