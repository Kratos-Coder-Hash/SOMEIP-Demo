...
*/
#ifndef V1_COMMONAPI_DEMO_COMM_HPP_
#define V1_COMMONAPI_DEMO_COMM_HPP_
...
const char* Comm::getInterface() {
    return ("commonapi.demo.Comm:v1_0");
}

CommonAPI::Version Comm::getInterfaceVersion() {
...
#endif // V1_COMMONAPI_DEMO_COMM_HPP_
