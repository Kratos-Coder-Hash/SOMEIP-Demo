 ...
 */
#ifndef V1_COMMONAPI_DEMO_COMM_SOMEIP_PROXY_HPP_
#define V1_COMMONAPI_DEMO_COMM_SOMEIP_PROXY_HPP_
...
public:
    ...
    virtual ~CommSomeIPProxy();

    virtual XAttribute& getXAttribute();

    virtual MyStatusEvent& getMyStatusEvent();

    virtual void sendMessage(std::string _name, CommonAPI::CallStatus &_internalCallStatus, Comm::stdErrorTypeEnum &_error, std::string &_message, const CommonAPI::CallInfo *_info);

    virtual std::future<CommonAPI::CallStatus> sendMessageAsync(const std::string &_name, SendMessageAsyncCallback _callback, const CommonAPI::CallInfo *_info);
...
#endif // V1_COMMONAPI_DEMO_Comm_SOMEIP_PROXY_HPP_
